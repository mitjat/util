# from https://github.com/wickman/python-bootstrap/blob/master/bootstrap_python.sh

unset CC  # As required for OSX Yosemite according to https://confluence.twitter.biz/display/ENG/Python+at+Twitter
...
pushd $SANDBOX
  ...
  for version in $PYTHON_2_7 $PYTHON_3_4; do
  ...
  for interpreter in $CPY-$PYTHON_2_7/bin/python2.7 \
